...
class QuizModel: QuizProtocol {
    ...
    init(rounds: Int, buttonFirst: UIButton, buttonSecond: UIButton, buttonThird: UIButton, buttonFourth: UIButton, view: UIView, label: UILabel, scrollView: UIScrollView, cellIndexPath: Int) {
