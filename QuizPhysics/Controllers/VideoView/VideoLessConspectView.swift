...
class VideoLessConspectView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if videoID == "tQpjz9x-o0Y" {
            ...
            guard let path = Bundle.main.url(forResource: "конспект к Давление твердых тел на поверхность. Сила давления-cropped", withExtension: "pdf") else { return }
            ...
            guard let path = Bundle.main.url(forResource: "конспект к Давление жидкостей и газов. Закон Паскаля-cropped", withExtension: "pdf") else { return }
            ...
            guard let path = Bundle.main.url(forResource: "конспект к жидкостный насос-cropped", withExtension: "pdf") else { return }
            ...
            guard let path = Bundle.main.url(forResource: "конспект к Закон Архимеда-cropped", withExtension: "pdf") else { return }
