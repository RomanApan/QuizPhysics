...
class VideoLessTestView: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        model = VideoLessTestModel(rounds: rounds, buttonFirst: button1, buttonSecond: button2, buttonThird: button3, buttonFourth: button4, view: view, label: label, scrollView: scrollView, cellIndexPath: indexPath, videoId: self.videoID)
    }
    ...
    func setContsraints() {
        ...
        NSLayoutConstraint.activate([
            label.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 250),
    ...
    private func gameAlertIsEnd(newScore: Int) {
        ...
        let alert = UIAlertController(
            title: "Тест окончен",
            message: "Вы ответили правильно на \(newScore) \(zadanie)",
